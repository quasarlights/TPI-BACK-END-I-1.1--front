/////////////////////DELTE ODONTOLOGO/////////////////
const deleteSeccionBtn= document.getElementById('deleteOdontologoBTN')
const deleteIdForm= document.getElementById('give-id-form-delete')
const deleteForm= document.getElementById('odontologo-delete-form')
...
function hideUI() {
  deleteOdontologoBTN.disabled = true
...
deleteIdBtn.addEventListener('click', (e) => {
    ...
    try {
      fetch(`http://localhost:8080/odontologos/${idToDelete}`)
        .then((response) => {
